...
open class GrowingTextViewHandler: NSObject {
	...
	*/
 	public init(textView: UITextView, withHeightConstraint: NSLayoutConstraint) {
		super.init()
		growingTextView = textView
		textViewHeightConstraint = withHeightConstraint
		updateInitialHeightAndResize()
	}
	/**
	...
	*/
	open func resizeTextView(withAnimation: Bool) {
		...
		if let heightConstraint = textViewHeightConstraint , heightConstraint.constant != verticalAlignmentConstant {
			updateVerticalAlignmentWithHeight(verticalAlignmentConstant, animated: withAnimation)
		}
	...
	*/
	...
	open func setText(_ text: String, withAnimation: Bool) {
		self.growingTextView.text = text
		if text.characters.isEmpty {
			updateVerticalAlignmentWithHeight(self.initialHeight, animated: withAnimation)
		} else {
			resizeTextView(withAnimation: withAnimation)
		}
	}
    
    open func updateMinimumNumber(ofLines: Int, andMaximumNumberOfLine: Int) {
        self.minimumNumberOfLines = ofLines
        self.maximumNumberOfLines = andMaximumNumberOfLine
    }
	...
	*/
	...
	fileprivate func updateInitialHeightAndResize() {
		...
		resizeTextView(withAnimation: false)
	}
	/**
