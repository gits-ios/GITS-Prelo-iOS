...
public class MKRefreshControl: UIControl {
    ...
    private func setupRefreshControl() {
        self.frame = CGRectMake(0, 0, CGRectGetWidth(UIScreen.mainScreen().bounds), self.cHeight)
    ...
    private func setup() {
        ...
        self.radius = 15.0
        let center = CGPointMake(CGRectGetWidth(UIScreen.mainScreen().bounds) / 2, self.cHeight / 2)
    ...
    private func setFrameForScrolling(withOffset offset: CGFloat) {
        if -offset > self.cHeight {
            ...
            self.frame = CGRectMake(0, newY, CGRectGetWidth(UIScreen.mainScreen().bounds), self.cHeight)
            self.bounds = CGRectMake(0, 0, CGRectGetWidth(UIScreen.mainScreen().bounds), self.cHeight)
        }
    }
}
