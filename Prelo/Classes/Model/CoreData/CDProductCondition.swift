...
class CDProductCondition: NSManagedObject {
    ...
    static func getProductConditionWithID(_ id : String) -> CDProductCondition? {
        ...
        let fetchReq : NSFetchRequest<NSFetchRequestResult> = NSFetchRequest(entityName: "CDProductCondition")
    ...
    static func deleteAll(_ m : NSManagedObjectContext) -> Bool {
        let fetchRequest : NSFetchRequest<NSFetchRequestResult> = NSFetchRequest(entityName: "CDProductCondition")
