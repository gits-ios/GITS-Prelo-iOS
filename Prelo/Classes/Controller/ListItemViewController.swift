...
class ListItemViewController: BaseViewController, MFMailComposeViewControllerDelegate, FilterDelegate, CategoryPickerDelegate, ListBrandDelegate {
    ...
    @IBAction func topHeaderFilterSortPressed(_ sender: AnyObject) {
        ...
        if fltrProdKind == "0" {
            filterVC.jenisListingChecked = [true, false]
        } else if fltrProdKind == "1" {
            filterVC.jenisListingChecked = [false, true]
        } else if fltrProdKind == "2" {
            filterVC.jenisListingChecked = [true, true]
        } else {
            filterVC.jenisListingChecked = [false, false]
        }
