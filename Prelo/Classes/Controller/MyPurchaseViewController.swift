...
class MyPurchaseViewController : BaseViewController, CarbonTabSwipeDelegate {
    ...
    override func viewDidLoad() {
        ...
        tabSwipe = CarbonTabSwipeNavigation.init().createWithRootViewController(self, tabNames: ["DIPROSES", "SELESAI"] as [AnyObject], tintColor: UIColor.whiteColor(), delegate: self)
        tabSwipe?.addShadow()
